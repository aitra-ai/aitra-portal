<template>
  <div class="bg-white rounded-xl border border-gray-200 p-4 flex flex-col gap-3 hover:border-blue-300 hover:shadow-sm transition-all">
    ...
    <p class="text-sm font-medium text-gray-800 truncate" :title="model.model_name">
      {{ model.model_name }}
    </p>
    <el-button size="small" type="primary" class="w-full mt-auto" @click="onTry">
      {{ t('home.tryNow') }}
    </el-button>
  </div>
</template>
